...
type ServiceObservationHandler struct {
	serviceObservationUseCase application.ServiceObservationUsecase
}

func NewServiceObservationHandler(serviceObservationUseCase application.ServiceObservationUsecase) *ServiceObservationHandler {
